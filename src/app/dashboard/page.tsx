...
export default function DashboardPage() {
  const [selectedUser, setSelectedUser] = useState(users.find(user => user.role === 'team_manager') || users[0]);
  ...
  return (
    <div className={styles.sidebarContainer}>
      <Sidebar currentView="dashboard" onViewChange={handleViewChange} userRole={selectedUser.role} />
