          ...
          <Card sx={{ mb: 3 }}>
            ...
            <CardContent sx={{ p: 0 }}>
              ...
              {activeTab === "lca" && (
                <Box sx={{ p: 3 }}>
                  <Typography variant="h5" fontWeight={600} gutterBottom sx={{ mb: 3 }}>
                    Linguistic & Conversation Flow Analysis
                  </Typography>
                  ...
                  <Grid container spacing={3}>
                    <Grid item xs={12} md={6}>
                      <Card>
                        <CardContent>
                          <Typography variant="h6" gutterBottom>Speech Patterns</Typography>
                          <Box sx={{ mt: 2 }}>
                            <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                              <Typography variant="body2">Speaking Rate</Typography>
                              <Typography variant="body2" fontWeight={600}>145 WPM</Typography>
                            </Box>
                            <LinearProgress variant="determinate" value={72} sx={{ mb: 2 }} />
                            
                            <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                              <Typography variant="body2">Pause Frequency</Typography>
                              <Typography variant="body2" fontWeight={600}>Low</Typography>
                            </Box>
                            <LinearProgress variant="determinate" value={25} sx={{ mb: 2 }} />
                            
                            <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                              <Typography variant="body2">Volume Consistency</Typography>
                    ...
                    <Grid item xs={12} md={6}>
                      <Card>
                        <CardContent>
                          <Typography variant="h6" gutterBottom>Conversation Flow</Typography>
                          <Box sx={{ mt: 2 }}>
                            <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                              <CheckCircle sx={{ color: 'success.main', mr: 1 }} />
                              <Typography variant="body2">Proper greeting and introduction</Typography>
                            </Box>
                            <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                              <CheckCircle sx={{ color: 'success.main', mr: 1 }} />
                              <Typography variant="body2">Active listening demonstrated</Typography>
                            </Box>
                            <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                              <Warning sx={{ color: 'warning.main', mr: 1 }} />
                              <Typography variant="body2">Minor interruption detected</Typography>
                            </Box>
                            <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                              <CheckCircle sx={{ color: 'success.main', mr: 1 }} />
                              <Typography variant="body2">Clear problem resolution steps</Typography>
                            </Box>
                            <Box sx={{ display: 'flex', alignItems: 'center' }}>
                              <CheckCircle sx={{ color: 'success.main', mr: 1 }} />
                              <Typography variant="body2">Professional call closure</Typography>
                            </Box>
                          </Box>
                        </CardContent>
                      </Card>
                  ...
                  <Card sx={{ mt: 3 }}>
                    <CardContent>
                      <Typography variant="h6" gutterBottom>Language Quality Metrics</Typography>
