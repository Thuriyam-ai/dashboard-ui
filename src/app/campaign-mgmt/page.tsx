                    ...
                    <TableRow key={campaign.id} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                      ...
                      <TableCell>
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                          <Typography variant="body2" fontWeight={500}>Conv: {(campaign.conversations || 0).toLocaleString()}</Typography>
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}><Typography variant="body2" fontWeight={500} sx={{width: 75}}>Avg Score:</Typography><LinearProgress variant="determinate" value={campaign.avg_score || 0} color={getMetricColor(campaign.avg_score || 0)} sx={{ width: 50, height: 6, borderRadius: 3, flexGrow: 1 }} /><Typography variant="body2" fontWeight={600} color={`${getMetricColor(campaign.avg_score || 0)}.main`}>{campaign.avg_score || 0}%</Typography></Box>
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}><Typography variant="body2" fontWeight={500} sx={{width: 75}}>Completion:</Typography><LinearProgress variant="determinate" value={campaign.completion_rate || 0} color={getMetricColor(campaign.completion_rate || 0)} sx={{ width: 50, height: 6, borderRadius: 3, flexGrow: 1 }} /><Typography variant="body2" fontWeight={600} color={`${getMetricColor(campaign.completion_rate || 0)}.main`}>{campaign.completion_rate || 0}%</Typography></Box>
                        </Box>
                      </TableCell>
