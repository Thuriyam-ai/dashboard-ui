 ...
 * This is the overview page for Team Leaders with comprehensive team analytics.
 * @returns The TeamDashboardOverviewPage component
 */
export default function TeamDashboardOverviewPage() {
  ...
  return (
    <Box sx={{ minHeight: '100vh', backgroundColor: 'background.default' }}>
          ...
          <Toolbar>
            <Box sx={{ flexGrow: 1 }}>
              <Typography variant="body2" sx={{ fontFamily: 'monospace', color: 'text.secondary' }}>
                team-dashboard-overview.localhost:3000
              </Typography>
            </Box>
        ...
        <Container maxWidth="xl" sx={{ 
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="h6" color="text.secondary">
              Comprehensive team performance metrics and analytics for team leaders
            </Typography>
          </Box>
      ...
      {showLCAPanel && (
        <MuiLCAPanel
          conversationId="TEAM-DASHBOARD-OVERVIEW-001"
