import { BoltUser, BoltDashboardConfig } from '../../types/bolt-types';

export const boltUsers: BoltUser[] = [
  {
    id: '1',
    name: 'Priya Sharma',
...
export const boltDashboardConfigs: Record<string, BoltDashboardConfig> = {
  team_manager: {
    metrics: [
